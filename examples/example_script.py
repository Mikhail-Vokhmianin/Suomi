...
# link to the datasets: https://www.kaggle.com/datasets/kamendamov/russiaukraine-conflict-youtube-comments
...
result = sentino_test_results(df['Comments'][0])
